...
function populateHTML(data: ResumeData): void {
    ...
    const linkedinEl = document.getElementById('linkedin') as HTMLAnchorElement | null;
    const githubEl = document.getElementById('github') as HTMLAnchorElement | null;
